...
class DescargablesModal {
    ...
    validateTerritorialSelection() {
        const departmentSelect = this.document.getElementById("departamentos");
        const municipalitySelect = this.document.getElementById("municipios");
        const hasDepartment = Boolean(departmentSelect?.value?.trim());
        const hasMunicipality = Boolean(municipalitySelect?.value?.trim());
