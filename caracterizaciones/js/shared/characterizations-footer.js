(function initializeCharacterizationsFooter() {
    ...
    const footerAssets = footer.dataset.footerAssets || "img/footer";
    ...
    footer.innerHTML = `
                ...
                <div class="rowf">
                    ...
                    <div class="col-md-6f">
                        ...
                        <div class="redes-sociales">
                            <p><a class="btn" href="https://www.facebook.com/IgacColombia" tabindex="-1" target="_blank" rel="noopener"><img alt="Visitar Facebook IGAC" class="icono-redes" src="${footerAssets}/facebook.svg">Facebook IGAC</a></p>
                            <p><a class="btn" href="https://twitter.com/igacColombia" tabindex="-1" target="_blank" rel="noopener"><img alt="Visitar Twitter IGAC" class="icono-redes" src="${footerAssets}/twitter.svg">Twitter IGAC</a></p>
                            <p><a class="btn" href="https://www.instagram.com/accounts/login/?next=/igacColombia/" tabindex="-1" target="_blank" rel="noopener"><img alt="Visitar Instagram IGAC" class="icono-redes" src="${footerAssets}/instagram.svg">Instagram IGAC</a></p>
                        </div>
        ...
        <div class="gov-co-footer-pie">
            <div class="gov-co-footer-auto containerf">
                <img alt="Logo marca de Colombia" class="gov-co-logo-pie-blanco" src="${footerAssets}/marca_colombia.png">
                <img alt="Logo de Gov Co" class="gov-co-logo-pie-mesa" src="${footerAssets}/header_govco.png">
