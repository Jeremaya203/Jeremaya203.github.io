/**
 * layer-factory.js — Fábrica de Capas FeatureLayer
 *
 ...
 *
 * Dependencias:
 *   - layer-config.js para obtener la configuración de la capa
 *   - ArcGIS JS API (FeatureLayer)
 */
export class LayerFactory {
    constructor(config, colorService = null) {
        this.config = config;
    ...
    _buildRenderer(layerCfg, source = null) {
        ...
        if (mapConfig.colorDomain && this.colorService) {
            return this.colorService.buildUniqueValueRenderer(mapConfig.colorDomain, {
