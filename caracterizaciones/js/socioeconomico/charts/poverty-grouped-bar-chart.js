...
import { getRendererLegendItems } from "./core/chart-symbol-utils.js?v=travel-time-pie-20260511";
...
import { createVerticalGroupedBarOptions, formatChartLabel } from "./core/chart-options.js?v=global-safe-zoom-labels-20260604";
...
export function createPovertyGroupedBarChartController({
    ...
    async function updateChart(layer, config, options = {}) {
        ...
        if (!keepRendererLegend && typeof window.updateLegend === "function" && mapField) {
            window.updateLegend(
