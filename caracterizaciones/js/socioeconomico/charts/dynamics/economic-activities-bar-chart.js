import { getRendererVisualForValue } from "../core/chart-symbol-utils.js?v=travel-time-pie-20260511";
...
import {
    ...
    setChartTitle
} from "../ui/chart-panel.js?v=economic-no-scroll-20260707";
...
export function createEconomicActivitiesBarChartController({
    ...
    async function updateChart(layer, config) {
        ...
        const hasMunicipality = getTerritoryLevel?.() === "MUNI"
            && Boolean(String(getCurrentMunicipalityId?.() || "").trim());
