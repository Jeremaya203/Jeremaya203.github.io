import { socioeconomicoLayerUrl } from "../../services/service-roots.js";
import { TURISMO_INFRAESTRUCTURA_BAR_CHART_CONFIG } from "./socioeconomic-dynamics-charts-config.js?v=tourism-axis-labels-20260724";

const PIB_SERVICE_URL = socioeconomicoLayerUrl(7);
const ADDED_VALUE_SERVICE_URL = socioeconomicoLayerUrl(8);
const ECONOMIC_ACTIVITIES_SERVICE_URL = socioeconomicoLayerUrl(12);
...
export const PIB_VALUE_ADDED_PIE_CHART_CONFIG = {
    ...
    serviceUrl: ADDED_VALUE_SERVICE_URL,
    layerUrl: ADDED_VALUE_SERVICE_URL,
    url: ADDED_VALUE_SERVICE_URL,
...
export const ECONOMIC_ACTIVITIES_BAR_CHART_CONFIG = {
    ...
    serviceUrl: ECONOMIC_ACTIVITIES_SERVICE_URL,
    layerUrl: ECONOMIC_ACTIVITIES_SERVICE_URL,
    url: ECONOMIC_ACTIVITIES_SERVICE_URL,
