...
const GEOGRAPHIC_DICTIONARY_FEATURE_SERVER = "https://mapas2.igac.gov.co/server/rest/services/diccionariogeografico/bnngNombresGeograficos/MapServer";
const GEOGRAPHIC_DICTIONARY_DEPARTMENT_SOCIAL_URL = `${GEOGRAPHIC_DICTIONARY_FEATURE_SERVER}/9`;
const GEOGRAPHIC_DICTIONARY_MUNICIPAL_SOCIAL_URL = `${GEOGRAPHIC_DICTIONARY_FEATURE_SERVER}/20`;
const GEOGRAPHIC_DICTIONARY_REFERENCE_DEPARTMENT_SOCIAL_URL = `${GEOGRAPHIC_DICTIONARY_FEATURE_SERVER}/30`;
const GEOGRAPHIC_DICTIONARY_REFERENCE_MUNICIPAL_SOCIAL_URL = `${GEOGRAPHIC_DICTIONARY_FEATURE_SERVER}/37`;
...
export const PUBLIC_SERVICES_RADAR_CHART_CONFIG = {
    ...
    telecomCharts: {
        departmentServiceUrl: GEOGRAPHIC_DICTIONARY_DEPARTMENT_SOCIAL_URL,
        municipalityServiceUrl: GEOGRAPHIC_DICTIONARY_MUNICIPAL_SOCIAL_URL,
        departmentFallbackServiceUrls: [GEOGRAPHIC_DICTIONARY_REFERENCE_DEPARTMENT_SOCIAL_URL],
        municipalityFallbackServiceUrls: [GEOGRAPHIC_DICTIONARY_REFERENCE_MUNICIPAL_SOCIAL_URL],
