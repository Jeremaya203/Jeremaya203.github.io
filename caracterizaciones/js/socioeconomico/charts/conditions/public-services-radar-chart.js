...
import { getChartSymbolLookups, getRendererVisualForValue } from "../core/chart-symbol-utils.js?v=travel-time-pie-20260511";
...
export function createPublicServicesRadarChartController({
    ...
    async function updateChart(layer, config, options = {}) {
        ...
        if (!usesRendererLegend(config) && typeof window.updateLegend === "function") {
            window.updateLegend(
