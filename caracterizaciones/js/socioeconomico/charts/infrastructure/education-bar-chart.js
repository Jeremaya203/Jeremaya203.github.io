...
import { MUNICIPALITY_REQUIRED_CHART_MESSAGE } from "../ui/municipality-required-state.js?v=global-municipality-required-state-20260604";
import { createDefaultBarDataset, createBarChartOptions } from "../core/chart-options.js?v=education-staggered-axis-20260724";
...
import { getRendererLegendItems, getRendererVisualForValue } from "../core/chart-symbol-utils.js?v=support-infra-rest-legend2-20260516";
import { destroyCanvasChart } from "../core/chart-lifecycle.js";
import { createAdaptiveBarValueLabelsPlugin } from "../core/adaptive-bar-value-labels.js?v=global-safe-zoom-labels-20260604";
...
async function refreshTourismRendererLegend(layer, chartConfig, where) {
    if (typeof window.updateLegend !== "function" || !layer) return;
...
export function createEducationBarChartController({
    ...
    async function updateChart(layer, config, options = {}) {
        ...
        const isDepartmentWithoutMunicipality = chartConfig.allowDepartmentPopup === true
            && getTerritoryLevel?.() === "DEPTO"
            && !String(getCurrentMunicipalityId?.() || "").trim();
        ...
        if (!options.skipSyncMap && typeof window.updateLegend === "function" && chartConfig.id !== TURISMO_CHART_ID) {
            ...
            ? {
                ...
                layout: {
                    ...
                    padding: {
                        top: 8,
                        right: 12,
                        bottom: Number.isFinite(chartConfig?.xAxis?.bottomPadding)
