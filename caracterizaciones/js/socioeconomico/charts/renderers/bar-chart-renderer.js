...
import { createBarChartOptions, createDefaultBarDataset, createHorizontalStackedBarOptions } from "../core/chart-options.js?v=global-safe-zoom-labels-20260604";
...
import {
    ...
    groupChartFeatures
} from "../core/chart-utils.js?v=travel-time-pie-20260511";
import { getChartSymbolLookups, getRendererLegendItems } from "../core/chart-symbol-utils.js?v=connectivity-line-style-legend-20260602";
...
import {
    ...
    setChartTitle
} from "../ui/chart-panel.js?v=local-chart-title-20260529";
...
export function createBarChartRenderer({
    ...
    function renderRowsIntoChart(canvas, rows, chartConfig, layer = null, options = {}) {
        ...
        const syncLegendFromChartRows = () => {
            ...
            window.updateLegend(legendLabels, resolvedLegendColors, legendCodes, {
                field: legendField,
