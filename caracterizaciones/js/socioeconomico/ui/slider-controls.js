export function createSliderController({
    ...
    function handleTimeSliderInput(value) {
        ...
        if (
            ...
            activeDeforestationPeriod = period;
            ...
            if (period === "Todos") {
                ...
                const periodWhere = `${baseWhereStable} AND periodobosque = '${safePeriod}'`;
        ...
        if (
            ...
            const periodWhere = `${baseWhereStable} AND ${activeConfig.periodField} = '${selectedPeriodSafe}'`;

            if (getLayerGlobal()?.definitionExpression !== periodWhere) {
                applyWhereToActiveLayers(periodWhere);
            }
