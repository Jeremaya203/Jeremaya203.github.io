...
} from "./charts/configs/infrastructure-charts-config.js?v=education-health-axis-labels-20260724";
import {
    POVERTY_IPM_NBI_GROUPED_CONFIG,
    PUBLIC_SERVICES_RADAR_CHART_CONFIG
} from "./charts/configs/conditions-charts-config.js?v=telecom-diccionario-url-20260707";
import { socioeconomicoLayerUrl } from "./services/service-roots.js?v=sigi-service-roots-20260604";

import {
    SOCIAL_DYNAMICS_CONFIG
} from "./charts/configs/dynamics-charts-config.js?v=tourism-axis-labels-20260724";
