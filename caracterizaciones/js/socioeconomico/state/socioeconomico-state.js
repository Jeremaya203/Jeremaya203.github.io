...
export function createLayerStateAdapter(appState) {
    ...
    return {
        ...
        get currentMunicipalityId() { return values.currentMunicipalityId; }, set currentMunicipalityId(value) { values.currentMunicipalityId = value; },
        ...
        get territoryLevel() { return values.territoryLevel; }, set territoryLevel(value) { values.territoryLevel = value; },
        get currentDepartmentId() { return values.currentDepartmentId; }, set currentDepartmentId(value) { values.currentDepartmentId = value; },
