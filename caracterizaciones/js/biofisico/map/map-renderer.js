...
export function renderFallbackLegend({ layer, buildLegendFromRenderer, updateLegend }) {
...
export function updateLayerLegend({ layer, config, updateLegendByExtent, buildLegendFromRenderer, updateLegend }) {
    if (typeof updateLegendByExtent === "function") {
        updateLegendByExtent(layer, config);
        return;
    }

    renderFallbackLegend({ layer, buildLegendFromRenderer, updateLegend });
}
