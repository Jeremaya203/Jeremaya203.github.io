...
export { destroyLayerSafe, pickLayerByScale, getLandformsScaleTitle } from "./map-helpers.js";
import { buildStationsPopupContent as renderStationsPopupContent } from "./map-popup-renderer.js";
...
export function createBiofisicoStationsLayer({
    ...
    return createStationsLayer({
        ...
        buildPopupContent: (event) => renderStationsPopupContent(event, {
            escapeHtml,
            municipalityNames: getDiccionarioMunicipios(),
            departmentNames: getDiccionarioDepartamentos()
        })
    });
}
