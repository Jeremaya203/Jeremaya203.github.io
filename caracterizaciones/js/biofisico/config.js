...
export const DEPARTMENT_ONLY_LAYER_IDS = new Set([
    "hipsometria_depto",
    "bf3_geoformas",
    "temperatura_depto",
    "precipitacion_depto",
...
export const CLIMATE_RISK_LEGEND = [
...
export const ecosystemConditionColors = {
...
export const condicionLabelToCode = Object.entries(ecosystemConditionColors).reduce((acc, [code, obj]) => {
    acc[String(obj.label).trim().toLowerCase()] = String(code);
    return acc;
}, {});


export const slopeColors = {
...
export const slopeLabelToCode = Object.entries(slopeColors).reduce((acc, [code, obj]) => {
    acc[String(obj.label).trim().toLowerCase()] = String(code);
    return acc;
}, {});
