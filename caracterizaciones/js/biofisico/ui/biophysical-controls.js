export function renderBiofisicoSubTabs({
    ...
    const clearPreviousSectionVisuals = () => {
        ...
        card?.classList.remove("chart-ecosistemas", "chart-hipsometria", "chart-hipsometria-depto", "chart-bubble");
        ...
        const landformCharts = document.getElementById("geoformasCharts");
        if (landformCharts) landformCharts.style.display = "none";
    };
