...
export function temperatureStackedHandler(deps = {}) {
    return {
...
export function climateDepartmentAggregateStackedHandler(deps = {}) {
    return {
        when: (ctx) =>
        ...
        run: async (ctx) => {
            try {
                ...
                ctx.createChart(xLabels, null, null, "bar", true, datasets);
