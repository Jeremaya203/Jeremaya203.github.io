import { queryGroupSum } from "../chart-utils.js";
...
export function ecosystemsMunicipalHandler(deps = {}) {
    return {
        when: (ctx) =>
...
export function ecosystemConditionDepartmentDoughnutHandler(deps = {}) {
    const ecosystemConditionColors = deps.ecosystemConditionColors || globalThis.ecosystemConditionColors || {};
            ...
            try {
                ...
                const items = orderCodes
                    .map(code => {
                        ...
                        const info = ecosystemConditionColors?.[Number(code)] || ecosystemConditionColors?.[code];
                        return {
                            code,
