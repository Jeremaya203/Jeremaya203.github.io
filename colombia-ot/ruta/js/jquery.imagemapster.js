  ...
  m.MapData.prototype = {
    ...
    clearMapData: function (preserveState) {
      ...
      if (!preserveState) {
        ...
        if (this.imgCssText) {
          // CSP: style-src bloquea cssText. Solo se ejecuta si el <img> original
          // traía estilo inline capturado en el init (caso raro en este sitio,
          // ver imgCssText más arriba).
