  ...
  var prev = $("<li/>").addClass("prev").attr('id', 'prev').html("Anterior").click(function(){
    ...
    for (var i = 0; i < actual.length; i++) {
            ...
            showPage(i);
            $("#pagin li a").eq(i-1).css({"color": 'var(--azul-igac)'});
  ...
  $("#pagin li a").eq(0).css({"color": 'var(--azul-igac)'});
  $("#pagin li a").eq(0).addClass("current");
  
  $("#pagin li a").click(function() {
    $("#pagin li a").css({"color": '#000000'});
    $(this).css({"color": 'var(--azul-igac)'});
...
$('#boton-cerrar').click(function(){
  document.getElementById('primeranuncio').style.display = "none";
  //console.log("puedo cerrar el anuncio");
  //alert("hola");
